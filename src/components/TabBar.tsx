  ...
  return (
    <div
      style={{
        ...
        right: 14,
        flex: 'none',
        // Soft white floating pill, NO backdrop-filter: a live blur here repaints
        // every scroll frame and freezes scrolling on iOS Safari.
        background: '#FFFFFF',
        ...
        boxShadow: '0 12px 34px rgba(48,38,22,0.14), 0 2px 6px rgba(48,38,22,0.06)',
        zIndex: 30,
      }}
    >
      ...
      <button onClick={onCapture} style={{ flex: 1, display: 'flex', justifyContent: 'center', background: 'none', border: 'none', cursor: 'pointer' }} aria-label="Snap a meal">
        ...
        >
          <svg width="27" height="27" viewBox="0 0 24 24" fill="none" stroke="#FFFFFF" strokeWidth="2.3" strokeLinecap="round" strokeLinejoin="round">
