...
export const CHALLENGES: Challenge[] = [
  { id: 'c1', name: '7-Day Sugar Detox', cat: 'Eat better', color: '#FF7A93', tint: 'rgba(255,122,147,0.14)', people: '1.2k', days: 7, diff: 'Easy', reward: 'Sweet Escape', metric: 'days', target: 7 },
  { id: 'c2', name: '10K Steps Squad', cat: 'Move more', color: '#5BE39A', tint: 'rgba(91,227,154,0.14)', people: '3.6k', days: 30, diff: 'Medium', reward: 'Trailblazer', metric: 'steps', target: 10000 },
  { id: 'c3', name: 'Summer Shred', cat: 'Lose weight', color: '#FFB86B', tint: 'rgba(255,184,107,0.14)', people: '920', days: 21, diff: 'Hard', reward: 'Phoenix', metric: 'activities', target: 21 },
  { id: 'c4', name: 'Hydration Hero', cat: 'Feel good', color: '#6FA8FF', tint: 'rgba(111,168,255,0.14)', people: '2.1k', days: 14, diff: 'Easy', reward: 'Aqua Spirit', metric: 'days', target: 14 },
  { id: 'c5', name: 'Meal Prep Masters', cat: 'Eat better', color: '#9F8BFF', tint: 'rgba(159,139,255,0.14)', people: '780', days: 14, diff: 'Medium', reward: 'Kitchen Boss', metric: 'meals', target: 28 },
  { id: 'c6', name: 'Weekend Warrior', cat: 'Move more', color: '#FF9FD0', tint: 'rgba(255,159,208,0.14)', people: '1.5k', days: 30, diff: 'Hard', reward: 'Unstoppable', metric: 'activities', target: 12 },
]
